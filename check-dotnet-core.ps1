...
if($netCoreRuntime.Length -ne 9) { throw 'Wrong number of .NET Core runtimes installed' }
...
if($netCoreSDK.Length -ne 8) { throw 'Wrong number of .NET Core SDKs installed' }
if($netCoreSDK[0].Name -ne '1.0.0-preview2-1-003177') { throw '.NET Core SDK 1.0.0-preview2-1-003177 not found'}
if($netCoreSDK[1].Name -ne '1.0.0-preview2-003121') { throw '.NET Core SDK 1.0.0-preview2-003121 not found'}
if($netCoreSDK[2].Name -ne '1.0.0-preview2-003131') { throw '.NET Core SDK 1.0.0-preview2-003131 not found'}
if($netCoreSDK[3].Name -ne '1.0.0-preview2-003156') { throw '.NET Core SDK 1.0.0-preview2-003156 not found'}
